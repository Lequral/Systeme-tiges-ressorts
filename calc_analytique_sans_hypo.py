...
assert sp.simplify(expression_gamma1-expr_gamma1.subs({
    ...
    B1: (- b*k_1*r_22**2*r_3 + b*k_2*r_12**2*r_3 - gamma10*k_3*r_12**2*r_22**2 - k_1*r_12*r_22**2*r_3 *
         theta10 - k_2*r_12**2*r_22*r_3*theta20)/(k_1*r_22**2*r_3**2 + k_2*r_12**2*r_3**2 - k_3*r_12**2*r_22**2)
...
func = sp.lambdify((r_11, r_12, r_21, r_22, r_3, k_1,
                   k_2, k_3, b), equations, 'numpy')
...
variables = [r_11, r_12, r_21, r_22, r_3, k_1,
             k_2, k_3, b]  # theta10, theta20, gamma10,

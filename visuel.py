...
slider_biais = Slider(ax_slider_biais, 'biais', -1.0, 1.0, valinit=0)
...
def calcul(val = None):
    ...
    r_11_ex, r_12_ex, r_21_ex, r_22_ex, m_1_ex, m_2_ex, m_3_ex, g_ex, a_ex, b_ex, r_3_ex, L_ex, theta10_ex, theta20_ex, gamma10_ex,theta1_ex, theta2_ex, gamma1_ex, X01_ex, Y01_ex, F1_ex, T1_ex, X02_ex, Y02_ex, F2_ex, T2_ex, X03_ex, Y03_ex, k1_ex, k2_ex, k3_ex = dico["param"]
   
    equation = [e.subs({r_11_ex : r_11, 
                r_12_ex :r_12,
                r_21_ex : r_21,
                r_22_ex : r_22,
                g_ex : 9.81,
                ...
                m_1_ex : 1,
                m_2_ex : 1,
                m_3_ex : 1}) for e in equation]
        
    param = ( theta1_ex, theta2_ex, gamma1_ex, X01_ex, Y01_ex, T1_ex, X02_ex, Y02_ex, T2_ex, X03_ex, Y03_ex)
    ...
    theta1 = solu_param.x[3]
    theta2 = solu_param.x[4]
    gamma1 = solu_param.x[5]
    ...
    colors = ["blue", "blue", "purple", "green", "green", "purple", "yellow", "yellow"]
    ...
    print(f"theta 1 vaut {theta1}rad, theta 2 vaut {theta2}rad et l'output gamma 1 vaut {gamma1}")
